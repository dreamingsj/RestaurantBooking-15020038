...
class BookingSchedulerTest(unittest.TestCase):
    ...
    def test_현재날짜가_일요일인_경우_예약불가_예외처리(self):
        self.booking_scheduler = TestableBookingScheduler(CAPACITY_PER_HOUR, "2021/03/28 07:00")
    ...
    def test_현재날짜가_일요일이_아닌경우_예약가능(self):
        self.booking_scheduler = TestableBookingScheduler(CAPACITY_PER_HOUR, "2021/06/03 07:00")
